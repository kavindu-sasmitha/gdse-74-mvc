...
public class ItemModel {
    public String savedItem(ItemDto itemDto)throws SQLException,ClassNotFoundException{
       ...
       String sql="INSERT INTO Item VALUES (?,?,?,?,?)";
        ...
        return statement.executeUpdate()>0 ? "Succesfully saved Item":"Saved Faild";
    ...
    public String updateItem(ItemDto itemDto)throws SQLException,ClassNotFoundException{
       ...
       String sql="UPDATE Item SET Description = ?, PackSize = ?, UnitPrice = ?, QtyOnHand = ? WHERE ItemCode = ?";
        ...
        return statement.executeUpdate()>0 ? "Succesfully Update Item":"update Faild";
